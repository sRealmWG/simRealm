...
STEPL <- 0.1 # Sampling frequency multiplier (multiplies by N). Scaled so that, on average, 10% of the individuals die between every sample. Make sure this times N is an integer.
