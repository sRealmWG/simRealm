...
setwd('/data/idiv_chase/simRealm/data/neutral-ts-v2-10/')
...
neutral_beta_dist_10 <- tibble()
neutral_alpha_10 <- tibble()
for(i in 1:nrow(dat)){
  # counter for sanity
  ...
  neutral_beta_dist_10 = bind_rows(neutral_beta_dist_10, all_pairs)
  neutral_alpha_10 = bind_rows(neutral_alpha_10, alpha_temp)
}

save(neutral_beta_dist_10,
     neutral_alpha_10,
