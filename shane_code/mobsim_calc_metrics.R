...
save(alpha_scale_10,
     ...
     # beta_dist_50,
     # beta_dist_100,
     file = '~/Dropbox/1current/sRealm/simRealm/simRealm/prelim_results/mobsim_v2_alpha_metrics.Rdata')

write.csv(beta_dist_100, file = '~/Dropbox/1current/sRealm/simRealm/simRealm/prelim_results/mobsim_v2_beta_dist_100.csv')
write.csv(beta_dist_50, file = '~/Dropbox/1current/sRealm/simRealm/simRealm/prelim_results/mobsim_v2_beta_dist_50.csv')
write.csv(beta_dist_10, file = '~/Dropbox/1current/sRealm/simRealm/simRealm/prelim_results/mobsim_v2_beta_dist_10.csv')
