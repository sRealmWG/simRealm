...
setwd('/data/idiv_chase/simRealm/data/neutral-ts-v2-50/')
...
neutral_beta_dist_50 <- tibble()
neutral_alpha_50 <- tibble()
for(i in 1:nrow(dat)){
  # counter for sanity
  ...
  neutral_beta_dist_50 = bind_rows(neutral_beta_dist_50, all_pairs)
  neutral_alpha_50 = bind_rows(neutral_alpha_50, alpha_temp)
}

save(neutral_beta_dist_50,
     neutral_alpha_50,
